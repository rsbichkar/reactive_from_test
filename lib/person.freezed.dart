...
class _$PersonTearOff {
  ...
  _Person call({required String name, List<String>? emails}) {
    return _Person(
      name: name,
      emails: emails,
    );
...
abstract class $PersonCopyWith<$Res> {
  ...
  $Res call({String name, List<String>? emails});
}
...
class _$_Person with DiagnosticableTreeMixin implements _Person {
  _$_Person({required this.name, this.emails});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Person(name: $name, emails: $emails)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, name, const DeepCollectionEquality().hash(emails));
...
abstract class _Person implements Person {
  factory _Person({required String name, List<String>? emails}) = _$_Person;
